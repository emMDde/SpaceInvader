...
void initGyro()
{
	...
	HAL_Delay(10);
	Gyro_Write_Reg(0x20, 0x5F);  // Ctrl_reg1: Power ON, XYZ włączone, LPF Cutoff 25 hz, ODR 200 Hz
	Gyro_Write_Reg(0x21, 0x00);  // Ctrl_reg2: Ustawienia: Filtr HPF 0.5 hz
	Gyro_Write_Reg(0x22, 0x00);  // Ctrl_reg3: Wylaczenie przerwania
	Gyro_Write_Reg(0x23, 0x00);  // Ctrl_reg4: Ustawienie zakresu pomiarowego
	Gyro_Write_Reg(0x24, 0x00);  // Ctrl_reg5: Wylaczenie HPF
	HAL_Delay(50);
	readGyroData();
}
